...
$maket=mktime(date("H")+2,date("i")+30,date("s"),date("m"),date("d"),date("Y"));
}else{
//$maket=0;
...
else if($result1=="Sunday") $result1="یک شنبه";
...
$gy = 1600 + 400*div($g_day_no, 146097); /* 146097 = 365*400 + 400/4 - 400/100 +
400/400 */
